...
// Eyebrows
import eyebrow_1 from "./assets/eyebrow/eyebrow_1.png";
import eyebrow_2 from "./assets/eyebrow/eyebrow_2.png";
import eyebrow_3 from "./assets/eyebrow/eyebrow_3.png";
import eyebrow_4 from "./assets/eyebrow/eyebrow_4.png";
import eyebrow_5 from "./assets/eyebrow/eyebrow_5.png";

// Other
import background from "./assets/other/background.png";
...
export const CHARACTER_PARTS: CharacterPart[] = [
    ...
    { required: [{ question: 6, option: 1 }], image: cat_lips, mode: "source-over" },
    ...
    // Other
    { required: [], image: background, mode: "destination-over" },
    { required: [], image: frame, mode: "source-over" },
    { required: [], image: background, mode: "destination-in" },
];
